...
const GOZO_HIGHSPEED: BrandContent = {
  ...
  identity: {
    ...
    brandStory:
      "Gozo Highspeed was born from a shared vision to provide a reliable and efficient fast ferry service connecting the Maltese islands. A result of a collaboration between Virtu Ferries Gozo and Gozo Fast, Gozo Highspeed delivers the quickest and most reliable ferry service for commuters and tourists alike.\n\nWe understand that our customers value their time and want to travel efficiently between Malta and Gozo. That's why we offer the most convenient ferry schedules with multiple daily departures, allowing passengers to easily plan their journey. Our fast and reliable services ensure reduced waiting times and a stress-free journey, while our modern facilities provide the comfort and convenience travellers deserve.\n\nWith years of combined experience in the ferry industry, our team is dedicated to delivering top-notch service that meets and exceeds expectations — whether the passenger is commuting to work or exploring the beautiful Maltese islands.\n\nArrive faster and travel smarter with Gozo Highspeed — the ferry service that puts comfort and convenience first.",
    toneOfVoice: [
      "Clear — communicate in a concise, straightforward way. No unnecessary complexity, no jargon, no flowery filler.",
      "Professional — polished and knowledgeable. Every sentence should reinforce confidence in the service.",
      "Engaging — connect on a personal, friendly, approachable level. Speak with the passenger, not at them.",
      "Energetic — convey genuine excitement about getting people across faster, with high-frequency sailings and modern facilities.",
    ],
    keyMessages: [
      "Arrive faster and travel smarter with Gozo Highspeed.",
      "Known for impressive speed, unwavering reliability, and unmatched convenience — seamlessly connecting Malta and Gozo with swift, hassle-free journeys every time.",
      ...
      "Reduced waiting times, modern facilities, stress-free crossings.",
      "Built on the combined experience of Virtu Ferries Gozo and Gozo Fast.",
    ],
    whatToSay: [
      "Lead with the practical benefit — crossing time, frequency, ease of getting to/from Gozo.",
      "Use the four personality cues consistently: Reliable, Efficient, Customer-Centric, Friendly.",
  ...
  assets: {
    headerSubtitle:
      "Visual brand assets per the official Gozo Highspeed Brandbook — two-colour palette, Montserrat typography, and the speed-ferry icon lockup. Always pair the logo with the \"Operated By\" credit when possible.",
    logos: [],
    colours: [
    ...
    logoDos: [
      "Use the full logo with the \"Operated By Virtu Ferries Gozo · Gozo Fast\" tagline whenever possible.",
      "Place the logo on a clean white, brand-blue, or brand-red background; switch to the all-white version on darker imagery.",
      "When using a photo background, prefer the white logo and apply a slight darkening filter so the mark stays legible.",
      "Keep the speed-line icon and wordmark proportions exactly as supplied — they were drawn together.",
    ],
    logoDonts: [
      "Don't move, shrink, recolour, or remove individual elements from the speed-ferry mark.",
      "Don't warp, stretch, or rotate the logo.",
      "Don't add strokes, drop shadows, glows or any other effect to the logo.",
