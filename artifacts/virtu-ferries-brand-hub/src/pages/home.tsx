      ...
      >
        ...
        <div className="shrink-0 grid grid-cols-2 lg:grid-cols-4 gap-2.5 mb-5">
          {quickActions.map((action, i) => (
            <motion.button
              ...
              className="group relative flex items-start gap-2.5 px-3.5 py-3 rounded-2xl bg-[#0F0F0F] border border-[#1A1A1A] hover:border-[#2A2A2A] hover:bg-[#131313] transition-all duration-200 text-left overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#39A15F]/60 focus-visible:ring-offset-0"
            ...
            >
              ...
              <div className="h-7 w-7 rounded-lg bg-[#161616] border border-[#1F1F1F] grid place-items-center shrink-0 group-hover:border-[#39A15F]/40 group-hover:bg-[#39A15F]/10 transition-colors">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-[11px] text-[#52525B] group-hover:text-[#71717A] mt-0.5 transition-colors">
                  {action.hint}
                </div>
              </div>
            </motion.button>
        ...
        >
          <div className="shrink-0 flex items-center justify-between px-5 py-3 border-b border-[#1A1A1A]">
            <div className="flex items-center gap-2 text-[11px] uppercase tracking-[0.22em] text-[#71717A] font-semibold">
