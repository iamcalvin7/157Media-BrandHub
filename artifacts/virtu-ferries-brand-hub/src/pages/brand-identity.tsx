      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 bg-[#141414] border border-white/5 rounded-2xl border-l-4 border-l-[#1e82b4]">
            <h3 className="font-medium text-lg mb-5 flex items-center gap-2 text-white">
              <CheckCircle2 className="w-5 h-5 text-[#1e82b4]" />
              What to Say
            </h3>
            <ul className="space-y-3">
              {WHAT_TO_SAY.map((item, i) => (
                <li key={i} className="text-white/70 font-light text-sm leading-relaxed">{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div className="p-6 bg-[#141414] border border-white/5 rounded-2xl border-l-4 border-l-[#e01814]">
            ...
            <ul className="space-y-3">
              {WHAT_NOT_TO_SAY.map((item, i) => (
                <li key={i} className="text-white/70 font-light text-sm leading-relaxed line-through decoration-white/20">{item}</li>
              ))}
            </ul>
          </div>
        </div>
