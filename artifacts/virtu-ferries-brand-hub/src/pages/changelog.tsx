    ...
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      >
        <header className="space-y-4">
          <h1 className="font-extrabold text-4xl md:text-5xl text-[#18181B] tracking-tight">Knowledge Changelog</h1>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-[#FAFAFA] border border-[#E4E4E7] rounded-2xl">
