...
export default function Resources() {
  ...
  return (
    ...
    >
      ...
      <div className="p-8 bg-white border border-gray-100 rounded-2xl text-center space-y-4 relative overflow-hidden">
        <div className="absolute inset-0 bg-[#1e82b4]/5 opacity-50"></div>
        <Lock className="w-12 h-12 text-[#f6a610] mx-auto mb-4" />
        <h2 className="text-2xl font-semibold text-gray-900">Asset Vault Under Construction</h2>
        <p className="text-gray-500 max-w-md mx-auto font-light pb-4">
      ...
      <div className="space-y-4 opacity-50 pointer-events-none select-none grayscale">
        <h3 className="text-lg font-medium text-gray-900 px-2">Preview</h3>
