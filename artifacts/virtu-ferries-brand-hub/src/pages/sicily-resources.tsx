...
const CARDS: ResourceCard[] = [
  {
    ...
    title: "Sicily Towns",
    description:
      "Towns reachable from Pozzallo, grouped by drive time. Reference for destination content.",
    meta: "Towns under 4h",
    icon: MapPin,
  },
  {
    ...
    description:
      "Sicily's certified Blue Flag coastline, split between day-trip distance and weekend itineraries.",
    ...
    >
      <header className="space-y-2">
        ...
        <p className="text-sm text-[#71717A] font-light max-w-2xl leading-relaxed">
          Reference material for Sicily-side destination content, anchored to
          the Pozzallo terminal.
        </p>
      </header>
