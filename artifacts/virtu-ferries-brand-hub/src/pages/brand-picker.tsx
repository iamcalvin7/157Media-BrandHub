...
export default function BrandPicker() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0E0E0E] text-[#FAFAFA] overflow-hidden selection:bg-[#39A15F] selection:text-black">
      {/* Ambient atmosphere */}
      ...
      <div className="relative flex flex-col min-h-screen">
        ...
        <header className="px-6 sm:px-10 pt-7 pb-4 flex items-center justify-between gap-3">
          ...
          <nav className="hidden sm:flex items-center gap-1 rounded-full border border-[#222222] bg-[#161616]/80 backdrop-blur px-1 py-1">
            <span className="text-[11px] uppercase tracking-[0.18em] text-[#6B6B73] px-3">Workspace</span>
            <span className="h-3 w-px bg-[#272727]" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-3xl mx-auto">
                {brands.map((brand, i) => (
                  ...
                  >
                    ...
                    <div className="w-full h-[130px] bg-white flex items-center justify-center px-8">
